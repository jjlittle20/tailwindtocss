import CheatSheet from "./cheetsheet";
...
${smClasses.length !== 0 ? breakpoints[0][1].replace("...", "" + convertToCss(smClasses)) : ""}
${mdClasses.length !== 0 ? breakpoints[1][1].replace("...", "" + convertToCss(mdClasses)) : ""}
${lgClasses.length !== 0 ? breakpoints[2][1].replace("...", "" + convertToCss(lgClasses)) : ""}
${xlClasses.length !== 0 ? breakpoints[3][1].replace("...", "" + convertToCss(xlClasses)) : ""}
${_2xlClasses.length !== 0 ? breakpoints[4][1].replace("...", "" + convertToCss(_2xlClasses)) : ""}
${hoverClasses.length !== 0 ? `:hover { ${convertToCss(hoverClasses)} }` : ""}
`;

	return resultCss;
};

export const convertFromCssToJss = (input) => {
